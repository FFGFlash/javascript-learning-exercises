...
- [JavaScript Learning Exercises](#javascript-learning-exercises)
  ...
  - [Prerequisites](#prerequisites)
    - [Installing Node.js](#installing-nodejs)
      ...
      - [maxOS](#maxos)
        ...
        - [Option 2: Using Homebrew (if you have Homebrew installed)](#option-2-using-homebrew-if-you-have-homebrew-installed)
      - [Linux (Ubuntu/Debian)](#linux-ubuntudebian)
      - [Verify Installation](#verify-installation)
    - [Installing Visual Studio Code (Recommended)](#installing-visual-studio-code-recommended)
    ...
    - [Recommended VSCode Extensions](#recommended-vscode-extensions)
      - [Installing Extensions](#installing-extensions)
        ...
        - [Method 2: Using the Extensions sidebar](#method-2-using-the-extensions-sidebar)
    ...
    - [Alternative Code Editors](#alternative-code-editors)
      - [Method 1: Open Settings via Menu](#method-1-open-settings-via-menu)
      - [Method 2: Open Settings via Command palette](#method-2-open-settings-via-command-palette)
  ...
  - [Exercise Structure](#exercise-structure)
    - [Working Through an Exercise](#working-through-an-exercise)
  - [Tips for Success](#tips-for-success)
  - [VSCode Keyboard Shortcuts (Essential)](#vscode-keyboard-shortcuts-essential)
    - [General](#general)
    - [Editing](#editing)
  ...
  - [Common Issues](#common-issues)
    ...
    - [VSCode Terminal Not Working](#vscode-terminal-not-working)
